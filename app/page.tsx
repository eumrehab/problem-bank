...
export default function Home() {
  ...
  function choose(set: QuizSet) { setActiveBookSet(null); setSelectedId(set.id); setAnswers({}); setCurrent(0); setSubmitted(false); setView('quiz'); window.scrollTo(0, 0); }
  ...
  function chooseChapter(chapter: BookChapter) {
    ...
    setActiveBookSet(quizSet); setSelectedId(quizSet.id); setAnswers({}); setCurrent(0); setSubmitted(false); setView('quiz'); window.scrollTo(0, 0);
  }
